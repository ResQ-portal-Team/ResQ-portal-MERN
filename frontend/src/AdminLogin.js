...
const AdminLogin = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 p-6 font-sans dark:bg-gradient-to-br dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
